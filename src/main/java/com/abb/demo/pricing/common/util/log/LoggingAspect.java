...
public final class LoggingAspect {
    ...
    @Before("@annotation(com.abb.demo.pricing.common.util.log.LogName)")
    ...
    @Around("@annotation(com.abb.demo.pricing.common.util.log.LogTime)")
    private Object logExecutionTime(final ProceedingJoinPoint joinPoint) throws Throwable {
        ...
        if (LOG.isTraceEnabled()) {
            LOG.trace("--> Executed method {} in {}ms",
                    ...
                    joinPoint.getSignature().toShortString(), watch.getTotalTimeMillis());
        }
        return proceed;
